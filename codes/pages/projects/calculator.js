...
var popup_btns = document.querySelectorAll("#popup #form #popup_btn_container button");
...
function save_premise(){
    ...
    else if(0 > answer3 || answer3 > 100){ //Percentage
        valido = false;
        document.getElementById("premise_answer3").classList.add("error");
    }
    if(answer4 == ""){
    ...
    else if(0 > answer4 || answer4 > 24){ //hours/day
        valido = false;
        document.getElementById("premise_answer4").classList.add("error");
    }
    if(0 > answer5 || answer5 > 100){ //percentage
        valido = false;
        document.getElementById("premise_answer1").classList.add("error");
    }
